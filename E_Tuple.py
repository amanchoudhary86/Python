...
tpl3 = 1,2,3,4 #This is created without the use of paranthesis () for the ease of understanding. Enclosing the elements in paranthesis is totally up to you.

a,b,c,d = tpl3 # <-- This is an example of Tuple unpacking where elements of tpl3 are being unpacked and assigned to the variables a,b,c, and d

print(c)
# output = 3

random_var1 = -5
print(abs(random_var1))

random_var2 = 67
print(abs(random_var2))

# abs() function is a function which always returns the positive value. 'abs' stands for absolute.